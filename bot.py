...
def get_main_keyboard(user_id):
    ...
    keyboard.add("📂 FREE", "💎 VIP")
    keyboard.add("📱 APPS", "⚡ SERVICES")
...
@bot.message_handler(func=lambda m: m.text == "📂 FREE")
@force_join_handler
...
@bot.message_handler(func=lambda m: m.text == "📱 APPS")
@force_join_handler
...
def delete_folder_command(message):
    ...
    msg = bot.send_message(
        ...
        "Example: <code>free My Folder</code>\n\n"
...
def process_delete_folder(message):
    ...
    try:
        ...
        bot.send_message(
            ...
            f"Delete '{name}' from {category.upper()}?\n\n"
