...
# With Fixed Custom Buttons & Force Join (Admin Bypass)
# =========================
...
# =========================
# 🚫 FORCE JOIN (FIXED - ADMIN BYPASS)
# =========================
_force_cache = {}
FORCE_CACHE_TTL = 60

def force_block(uid):
    """Check if user joined required channels (admins bypass)"""
    global _force_cache
    now = time.time()
...
def start_cmd(m):
    ...
    # Check force join - ADMINS BYPASS
    if force_block(uid):
        return
