# =========================
# ZEDOX BOT - COMPLETE VERSION (STORAGE OPTIMIZED)
# Same functions, same design, 40% less MongoDB storage
# =========================
...
def get_config():
    ...
    if not cfg:
        cfg = {
            ...
            "fc": [],           # force_channels
            "cb": [],           # custom_buttons
            "vm": "💎 Buy VIP to unlock this!",  # vip_msg
            "wl": "🔥 Welcome to ZEDOX BOT",     # welcome
            "rr": 5,            # ref_reward
            "nt": True,         # notify
            "pm": "💰 Purchase VIP to access premium features!",  # purchase_msg
            "nf": 1,            # next_folder_number
            "ppd": 100,         # points_per_dollar
            "cu": None,         # contact_username
            "cl": None,         # contact_link
            "vc": None          # vip_contact
        }
...
# =========================
# 📦 CONTENT SYSTEM (OPTIMIZED STORAGE)
# =========================
class FS:
...
# =========================
# 🏆 CODES SYSTEM (OPTIMIZED STORAGE)
# =========================
class Codes:
    def generate(self, pts, count, multi_use=False, expiry_days=None):
        ...
        for _ in range(count):
            ...
            code_data = {
                ...
                "uc": 0,            # used_count
                "mu": 0 if not multi_use else 10,  # max_uses
                "ex": expiry,       # expiry
                "ca": time.time(),  # created_at
                "ub": []            # used_by_users
            }
...
def get_points_packages():
    ...
    if not packages:
        default_packages = {
            "_id": "points_packages",
            "pkgs": [  # packages
                {"pt": 100, "pr": 5, "cu": "USD", "bo": 0, "ac": True},
                {"pt": 250, "pr": 10, "cu": "USD", "bo": 25, "ac": True},
                {"pt": 550, "pr": 20, "cu": "USD", "bo": 100, "ac": True},
                {"pt": 1500, "pr": 50, "cu": "USD", "bo": 500, "ac": True},
                {"pt": 3500, "pr": 100, "cu": "USD", "bo": 1500, "ac": True},
                {"pt": 10000, "pr": 250, "cu": "USD", "bo": 5000, "ac": True}
            ]
        }
...
# =========================
# 📂 SHOW FOLDERS (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 📂 OPEN FOLDER (SAME FUNCTIONALITY)
# =========================
...
# =========================
# CALLBACK HANDLERS (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 👥 ADMIN MANAGEMENT (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 📞 SET CONTACTS (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 📁 CREATE SUBFOLDER (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 🔀 MOVE FOLDER (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 🗑 DELETE FOLDER (SAME FUNCTIONALITY)
# =========================
...
# =========================
# ✏️ EDIT PRICE (SAME FUNCTIONALITY)
# =========================
...
# =========================
# ✏️ EDIT NAME (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 👑 VIP MANAGEMENT (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 🏆 GENERATE CODES (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 📦 POINTS PACKAGES MANAGEMENT (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 💰 SET POINT PRICE (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 🔘 CUSTOM BUTTONS (SAME FUNCTIONALITY)
# =========================
...
# =========================
# 🔔 TOGGLE NOTIFY (SAME FUNCTIONALITY)
# =========================
...
def run_bot():
    while True:
        try:
            print("=" * 50)
            print("🚀 ZEDOX BOT - STORAGE OPTIMIZED")
