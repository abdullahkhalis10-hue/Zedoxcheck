...
def get_config():
    ...
    if not cfg:
        cfg = {
            ...
            "contact_username": None,  # Admin contact username
            "contact_link": None,       # Admin contact link
            "vip_contact": None         # VIP purchase contact
        }
...
def is_admin(uid):
    """Check if user is admin (main admin or added admin)"""
...
def admin_management(m):
    # Only main owner can manage admins
...
# =========================
# 📤 UPLOAD SYSTEM (SAME AS BEFORE - KEPT FOR COMPLETENESS)
# =========================
