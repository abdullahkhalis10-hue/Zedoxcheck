...
# With VIP Pricing, Payment Methods, Referral Rewards System
# =========================
...
def get_config():
    ...
    if not cfg:
        cfg = {
            ...
            "vip_contact": None,
            # NEW SETTINGS
            "vip_price": 50,  # VIP price in dollars
            "vip_points_price": 5000,  # VIP price in points
            "payment_methods": ["💳 Binance", "💵 USDT (TRC20)", "💰 Bank Transfer", "🪙 Bitcoin"],
            "referral_vip_count": 50,  # Number of referrals to get VIP
            "referral_purchase_count": 10,  # Number of referred users who bought VIP to get VIP
            "vip_duration_days": 30  # VIP duration in days (0 = permanent)
        }
...
# =========================
# 👤 USER SYSTEM (UPDATED WITH REFERRAL TRACKING)
# =========================
class User:
    _cache = {}
    _cache_time = {}
    ...
    def add_ref(self):
        ...
        # Check if user should get VIP from referrals
    ...
    def add_ref_bought_vip(self):
        ...
        # Check if user should get VIP from referrals who bought VIP
        config = get_cached_config()
...
# =========================
# 🚀 START + REFERRAL SYSTEM (IMPROVED MESSAGE)
# =========================
...
# =========================
# 📂 OPEN FOLDER (UPDATED WITH BUY VIP)
# =========================
...
# =========================
# CALLBACK HANDLERS (UPDATED WITH VIP PRICING)
# =========================
...
def get_vip_callback(c):
    ...
    # Add buy with points button if user has enough points
...
# =========================
# ⚙️ ADMIN PANEL (UPDATED WITH NEW SETTINGS)
# =========================
def admin_menu():
    kb = ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    kb.row("⚙️ VIP Settings", "💳 Payment Methods")  # NEW
...
# =========================
# 📞 SET CONTACTS (FIXED CUSTOM LINK)
# =========================
